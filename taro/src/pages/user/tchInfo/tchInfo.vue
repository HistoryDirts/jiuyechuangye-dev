        ...
        <div class="main_body">
            <div class="user_opt">
                ...
                >
                    ...
                    <el-descriptions-item label="指导方向">{{form.tch.guidance}}</el-descriptions-item>
                    <el-descriptions-item label="特长">{{form.tch.specialty}}</el-descriptions-item>
                    <el-descriptions-item label="爱好">{{form.tch.hobby}}</el-descriptions-item>
                </el-descriptions>
                <el-form>
                    <el-form-item class="submit_box2">
...
import Taro from '@tarojs/taro';
    export default {
        ...
        methods: {
            ...
            edit(){
                Taro.navigateTo({
                    url:'pages/user/tchInfo/tchInfoEdit'
                })
                this.$message({
                    type: "success",
                    message: '注意及时保存信息'
