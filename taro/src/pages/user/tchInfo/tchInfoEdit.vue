<template>
    <div style="background:gray">
        ...
        <div class="main_body">
            <div class="user_opt">
                <span style="position: relative; left: 10%">导师其他信息</span>
                <el-form ref="form" :model="form" size="normal" :rules="rules">
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        <span style="float: left">ID：</span>
                        <el-input style="float: right; right: 20%; width: 60%" disabled prefix-icon="el-icon-s-custom" v-model="form.tch.id" placeholder="ID不可修改"></el-input>
                    </el-form-item>
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        <span style="float: left">用户名：</span>
                        <el-input style="float: right; right: 20%; width: 60%" maxlength="12" minlength="2" prefix-icon="el-icon-user-solid" v-model="form.tch.name" placeholder="请输入用户名"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        <span style="float: left">指导方向：</span>
                        <el-input style="float: right; right: 20%; width: 60%" prefix-icon="el-icon-school" v-model="form.tch.guidance" placeholder="请输入专业"></el-input>
                    </el-form-item>
                    <el-form-item style="position: relative; left: 10%" prop="number">
                        <span style="float: left">特长：</span>
                        <el-input style="float: right; right: 20%; width: 60%" prefix-icon="el-icon-office-building" v-model="form.tch.specialty" placeholder="请输入特长"></el-input>
                    </el-form-item>
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        <span style="float: left">爱好：</span>
                        <el-input style="float: right; right: 20%; width: 60%" prefix-icon="el-icon-s-opportunity" v-model="form.tch.hobby" placeholder="请输入爱好"></el-input>
                    </el-form-item>
                </el-form>
                <el-form>
