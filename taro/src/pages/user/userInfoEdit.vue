<template>
    <div style="background:gray">
        ...
        <div class="main_body">
            <div class="user_opt">
                <span style="position: relative; left: 10%">学生基本信息</span>
                <el-form ref="form" :model="form" size="normal" :rules="rules">
                    ...
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        <span style="float: left">国籍：</span>
                        <el-input style="float: right; right: 20%; width: 60%" prefix-icon="el-icon-s-flag" v-model="form.nationality" placeholder="请输入国籍"></el-input>
                    </el-form-item>
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        <span style="float: left">用户身份：</span>
                ...
                <span style="position: relative; left: 10%">学生自我介绍</span>
                <el-form ref="form" :model="form" size="normal" :rules="rules">
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        <span style="float: left">用户简介：</span>
                        <textarea style="float: right; right: 20%; position:absolute; width: 60%; height: 80px; top: 10px" prefix-icon="el-icon-user-solid" v-model="form.intro" placeholder="请输入专业"></textarea>
                    </el-form-item>
                </el-form>
                <el-form>
