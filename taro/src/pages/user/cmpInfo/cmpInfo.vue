        ...
        <div class="main_body">
            <div class="user_opt">
                <el-descriptions
                    ...
                    border
                >
                    <el-descriptions-item label="ID">{{form.cmp.id}}</el-descriptions-item>
                    <el-descriptions-item label="用户名">{{form.cmp.name}}</el-descriptions-item>
                    <el-descriptions-item label="学/工号">{{form.number}}</el-descriptions-item>
                    <el-descriptions-item label="主要业务">{{form.cmp.business}}</el-descriptions-item>
                    <el-descriptions-item label="官网链接">{{form.cmp.linkman}}</el-descriptions-item>
                </el-descriptions>
                <el-descriptions
                    title="企业介绍"
                    direction="vertical"
                    ...
                    border
                >
                    <el-descriptions-item label="企业简介">{{form.cmp.profile}}</el-descriptions-item>
                </el-descriptions>
                <el-form>
                    <el-form-item class="submit_box3">
...
import Taro from '@tarojs/taro';
    export default {
        ...
        methods: {
            ...
            edit(){
                Taro.navigateTo({
                    url:'pages/user/cmpInfo/cmpInfoEdit'
                })
                this.$message({
                    type: "success",
                    message: '注意及时保存信息'
