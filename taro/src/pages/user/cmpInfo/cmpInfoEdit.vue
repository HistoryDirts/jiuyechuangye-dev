            ...
            <div class="user_opt">
                ...
                <el-form ref="form" :model="form" size="normal" :rules="rules">
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        ...
                        <el-input style="float: right; right: 20%; width: 60%" disabled prefix-icon="el-icon-s-custom" v-model="form.cmp.id" placeholder="ID不可修改"></el-input>
                    </el-form-item>
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        <span style="float: left">用户名：</span>
                        <el-input style="float: right; right: 20%; width: 60%" maxlength="12" minlength="2" prefix-icon="el-icon-user-solid" v-model="form.cmp.name" placeholder="请输入用户名"></el-input>
                    </el-form-item>
                    <el-form-item style="position: relative; left: 10%" prop="number">
                        <span style="float: left">学/工号：</span>
                        <el-input style="float: right; right: 20%; width: 60%" maxlength="10" minlength="8" prefix-icon="el-icon-user" v-model="form.cmp.number" placeholder="请输入学号/工号(12位以内)"></el-input>
                    </el-form-item>
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        <span style="float: left">主页业务：</span>
                        <el-input style="float: right; right: 20%; width: 60%" prefix-icon="el-icon-school" v-model="form.cmp.business" placeholder="请输入专业"></el-input>
                    </el-form-item>
                    <el-form-item style="position: relative; left: 10%" prop="number">
                        <span style="float: left">企业链接：</span>
                        <el-input style="float: right; right: 20%; width: 60%" prefix-icon="el-icon-office-building" v-model="form.cmp.linkman" placeholder="请输入特长"></el-input>
                    </el-form-item>
                    <el-form-item style="position: relative; left: 10%" prop="name">
                        <span style="float: left">企业简介：</span>
                        <el-input style="float: right; right: 20%; width: 60%" prefix-icon="el-icon-s-opportunity" v-model="form.cmp.profile" placeholder="请输入爱好"></el-input>
                    </el-form-item>
                </el-form>
                <el-form>
