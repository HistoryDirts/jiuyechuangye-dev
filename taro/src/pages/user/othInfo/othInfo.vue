        ...
        <div class="main_body">
            <div class="user_opt">
                ...
                >
                    ...
                    <el-descriptions-item label="特长">{{form.other.business}}</el-descriptions-item>
                    <el-descriptions-item label="爱好">{{form.other.linkman}}</el-descriptions-item>
                </el-descriptions>
                <el-descriptions
                    title="个人介绍"
                    direction="vertical"
                    ...
                    border
                >
                    <el-descriptions-item label="补充">{{form.intro}}</el-descriptions-item>
                </el-descriptions>
                <el-form>
                    <el-form-item class="submit_box4">
...
import Taro from '@tarojs/taro';
    export default {
        ...
        methods: {
            ...
            edit(){
                Taro.navigateTo({
                    url:'pages/user/othInfo/othInfoEdit'
                })
                this.$message({
                    type: "success",
                    message: '注意及时保存信息'
