        ...
        <div class="main_body">
            <div class="user_opt">
                <el-descriptions
                    ...
                    border
                >
                    <el-descriptions-item label="ID">{{form.stu.id}}</el-descriptions-item>
                    <el-descriptions-item label="用户名">{{form.stu.name}}</el-descriptions-item>
                    <el-descriptions-item label="学/工号">{{form.stu.number}}</el-descriptions-item>
                    <el-descriptions-item label="专业">{{form.stu.majorName}}</el-descriptions-item>
                    <el-descriptions-item label="特长">{{form.stu.specialty}}</el-descriptions-item>
                    <el-descriptions-item label="爱好">{{form.stu.hobby}}</el-descriptions-item>
                </el-descriptions>
                <el-form>
                    <el-form-item class="submit_box1">
...
import Taro from '@tarojs/taro';
    export default {
        ...
        methods: {
            ...
            edit(){
                Taro.navigateTo({
                    url:'pages/user/stuInfo/stuInfoEdit'
                })
                this.$message({
                    type: "success",
                    message: '注意及时保存信息'
